...
#if !defined(ING_NO_STD_SOURCE_LOCATION) && __has_include(<source_location>)
# include <source_location>
#endif

#if !defined(__cpp_lib_source_location) && !defined(ING_NO_STD_SOURCE_LOCATION) && \
...
#endif
            boost::source_location loc = boost::source_location()
#endif
        ) noexcept
        {
